       ...
       <v-card-text>
       	<div class= "table-responsive">
                  <table class="table table-striped table-hover">
                      <thead>
                          <tr>
                              <th scope="col" id="datetime">Date Time</th>
                              <th scope="col" id="text">Text</th>
                              <th scope="col" id="username">Username</th>
                          </tr>
                      </thead>
                      <tbody>
                          <tr v-for="formula in getItems"  >
                              <td scope="row" headers="datetime">{{formula.datetime}}</td>
                              <td scope="row" headers="text">{{formula.text}}</td>
